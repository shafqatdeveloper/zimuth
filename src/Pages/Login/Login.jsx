...
const Login = () => {
  ...
  return (
    <div className="w-full h-full flex py-32 items-center justify-center bg-darkWhite dark:bg-darkBlack text-darkBlack dark:text-darkWhite">
      <div className="w-full flex items-center justify-center">
        <form
          onSubmit={handleLogin}
          name="login"
          className="bg-white dark:bg-[#22262b] shadow-md shadow-black/20 rounded-md w-[27%] flex flex-col gap-6 p-3"
        >
